(function (factory) {
  ...
  */
  ...
  function getPropertyInfo(key, value, _ref2) {
    var typedProperties = _ref2.typedProperties;
    ...
    return {
      ...
      subtype: function () {
        ...
        var subKey = pluralize.isPlural(key) ? pluralize.singular(key) : key;
  ...
  function buildSetter(property, _ref) {
    var typedProperties = _ref.typedProperties,
        typedMethods = _ref.typedMethods;
  ...
  function buildGetter(property, _ref2) {
    var typedProperties = _ref2.typedProperties,
        typedMethods = _ref2.typedMethods;
  ...
  function create_each_block(ctx) {
  	...
  	return {
  		c() {
  			...
  			t1 = text(t1_value);
  			t2 = space();
  			attr(input, "title", ctx[10].key);
  			attr(input, "class", "form-check-input");
  			attr(input, "type", "checkbox");
  			attr(input, "id", ctx[10].key);
  			attr(label, "class", "form-check-label");
  			attr(label, "for", ctx[10].key);
